...
private:
    ...
    //std::vector<double> connXPos, connYPos, connXPos2, connYPos2; //Connection posisistion (contenios domain)
    ...
    double mcP, mcP2;
    //std::vector<int> lcP, mcP, lcP2, mcP2, lcT; //Connection posistions (discrete domain)
