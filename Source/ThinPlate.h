...
//void updateParameters(const double T60ToSet, const double LxToSet, const double LyToSet, const double excXToSet, const double excYToSet, const double lisXToSet, const double lisYToSet, const double thicknessToSet, const double excFToSet, const double excTToSet);
...
//float getOutput(double lisXposToSet, double lisYposToSet) {return u[1][static_cast <int> (floor(lisXposToSet*Lx)) + static_cast <int> (floor(lisYposToSet*Ly))*Nx];};
    
//float getOutput() {return u[1][static_cast <int> (floor(lisXpos*Nx)) + static_cast <int> (floor(lisYpos*Ny))*Nx]*0.000001;};
float getOutput() {return u[static_cast <int> (floor(lisXpos*Nx))][static_cast <int> (floor(lisYpos*Ny))]*0.000001;};
//float getOutput() {return u[1][12 + 12*Nx]*0.000005;};
